...
import type { Project, CustomAPIProjectsResponse, CustomAPIProject, SupabaseProject } from "./types";
...
export async function fetchProjects(): Promise<Project[]> {
  ...
  if (!apiUrl) {
    throw new Error("API URL not configured. Please set your API URL in extension preferences.");
  }
